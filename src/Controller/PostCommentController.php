...
use App\Validator\Exception\CommentNotFound;
...
class PostCommentController extends ApiController
{
    ...
    /**
     * @Route("/api/comment/{commentId}", name="Get comment", methods={"GET", "OPTIONS"})
     */
    ...
    /**
     * @Route("/api/comment/{commentId}", name="Delete comment", methods={"DELETE", "OPTIONS"})
     */
    ...
    /**
     * @Route("/api/comment/{commentId}", name="Update a comment", methods={"PATCH", "OPTIONS"})
     */
